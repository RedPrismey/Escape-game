...
/**
 * The Rectangle class represents a rectangle defined by its top-left corner (x, y),
 * its width, and its height. It provides a method to check if a point is contained within the rectangle.
...
public class Rectangle {
    ...
    /**
     * Check if the given coordinates (x, y) are within the bounds of this Rectangle,
     ...
     * @return true if the point (x, y) is within the rectangle defined by (rectX, rectY, rectWidth, rectHeight) after scaling, false otherwise
     */
    ...
    /**
     * For debugging purposes, this method draws the rectangle on the given Graphics context.
     *
