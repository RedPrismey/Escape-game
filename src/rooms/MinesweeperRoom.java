...
public class MinesweeperRoom extends Room {
  ...
  public MinesweeperRoom(
      String name,
      int id, List<Room> linkedTo) {
  ...
  public void draw(Graphics2D g, int width, int height) {
    ...
    g.fillRect(1300, 800, 600, 150);

    g.setColor(Color.BLACK);
    g.setFont(new Font("Arial", Font.BOLD, 30));
    g.drawString("Cliquez pour révéler", 1310, 840);
    g.drawString("Appuyez sur A pour placer un drapeau", 1310, 880);
    int minesLeft = MinesweeperRoom.totalMines - getNbFlags();
    g.drawString("Nombre de mines restantes : " + minesLeft, 1310, 920);
